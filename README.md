...
Dynamit is used by [RESTar](https://develop.mopedo.com/RESTar), a package developed by Mopedo to help create powerful RESTful web services for Starcounter applications. Using RESTar, REST clients can insert arbitrary data into `DDictionary` objects.
